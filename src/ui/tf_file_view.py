from PySide6.QtWidgets import QWidget, QVBoxLayout, QListView, QFileSystemModel, QLineEdit, QAbstractItemView, QHBoxLayout, QPushButton, QStyle, QMenu, QInputDialog, QMessageBox, QToolTip, QScrollArea, QFrame, QSlider, QComboBox, QLabel
...
class TasmaFileView(QWidget):
    ...
    def _copy_selection(self):
        ...
        if index.isValid():
            self._clipboard_path = self.model.filePath(index)
